...
public class LITPlinuxfirewallapiTestRunner extends TorTestCaseHelper {
    
    Logger logger = Logger.getLogger(LITPlinuxfirewallapiTestRunner.class);
    ...
    @TestId(id = "CXP9031174-1", title = "Upgrade ERIClitplinuxfirewallapi rpm on the MS")
    @Test(groups={"ACCEPTANCE"})
    public void upgradeERIClitplinuxfirewallapiRPM() throws TimeoutException, FileNotFoundException {

        rpmUpgradeOperator.initialise("linuxfirewallapi");
     ...
     * @PRIORITY HIGH
     */
    @TestId(id = "CXP9031174-2", title = "Run python test cases for ERIClitplinuxfirewallapi package")
    @Test(groups={"CDB_REGRESSION", "ACCEPTANCE"})
    public void runERIClitplinuxfirewallapiTests() {
     ...
     * @PRE Execution of test {@link #runERIClitplinuxfirewallapiTests()}
     * @PRIORITY HIGH
     * @param className
     * @param name
     * @param failures
     */
    @TestId(id = "CXP9031174-3", title = "Parse xml outputs from python tests")
